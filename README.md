...
I'm a **Data Analyst** passionate about turning complex data into clear, actionable insights. My work sits at the intersection of:

- 🧠 **Business Intelligence**
- ⚙️ **Data Engineering** 
- 🤖 **Process Automation**

Currently working at **Expleo Group** 🚗 on the FOTA (Firmware Over-The-Air) project for Renault, where I:

- 📊 Analyze large-scale data with **BigQuery**
...
| ⚡ **Performance** | Built with Next.js 14 & TypeScript |
| 🎭 **Interactive** | Framer Motion powered transitions |
| 🏢 **Professional** | Company logos & branding |
...
|---------|-------------|------------|
| 🤖 **AI Document Generator** | Automated technical deliverables generation | Django, OpenAI API, Celery |
| 📱 **Pharmacy Locator** | Find open pharmacies outside hours | Laravel, Flutter, Google Maps |
| 🧀 **Cheese Cave Management** | Inventory tracking system | C#, .NET, SQL Server |
| 📊 **FOTA Analytics Dashboard** | Campaign monitoring for Renault | BigQuery, Looker Studio, Python |
